...
pub(crate) struct GatewayArgs {
    #[arg(long, env = "LOCUS_GATEWAY_HTTP_PORT", default_value_t = 8080)]
    pub(crate) http_port: u16,

    #[arg(long, env = "LOCUS_GATEWAY_GRPC_PORT", default_value_t = 8081)]
    pub(crate) grpc_port: u16,

    #[arg(
        long,
        env = "LOCUS_GATEWAY_BACKEND",
        value_enum,
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_ROOT_DIR_NAME",
        default_value = ".locus-gateway"
    )]
    pub(crate) root_dir_name: String,

    #[arg(long, env = "LOCUS_GATEWAY_REMOTE", default_value_t = false)]
    pub(crate) remote: bool,

    #[arg(
        long,
        env = "LOCUS_GATEWAY_CORS_ENABLED",
        default_value_t = true,
        action = ArgAction::Set
    )]
    pub(crate) cors_enabled: bool,

    #[arg(long, env = "LOCUS_GATEWAY_CORS_ALLOWED_ORIGINS", default_value = "*")]
    ...
    #[arg(long, env = "LOCUS_SURREAL_DATABASE", default_value = "locus_gateway")]
    pub(crate) surreal_database: String,

    #[arg(long, env = "LOCUS_SURREAL_USER", default_value = "root")]
    pub(crate) surreal_user: String,

    #[arg(long, env = "LOCUS_SURREAL_PASSWORD", default_value = "root")]
    pub(crate) surreal_password: String,

    #[arg(long, env = "LOCUS_GATEWAY_EMBEDDINGS_ENABLED", default_value_t = false)]
    pub(crate) embeddings_enabled: bool,

    #[arg(
        long,
        env = "LOCUS_GATEWAY_EMBEDDINGS_PROVIDER",
        value_enum,
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_EMBEDDINGS_ENDPOINT",
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_EMBEDDINGS_MODEL",
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_EMBEDDINGS_REPO",
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_AVEC_SCORING_ENABLED",
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_AVEC_SCORING_ENDPOINT",
    ...
    #[arg(
        long,
        env = "LOCUS_GATEWAY_AVEC_SCORING_MODEL",
