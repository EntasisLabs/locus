...
<main class="wrap">
	<section class="hero">
		...
		<p class="lead">
			Same memory, four ways in. Pick the surface you already use. The commands below are the fast
			first run for each one.
		</p>
	</section>
	...
	<section class="grid" style="margin-bottom: 8px">
		<article class="card">
			<h3>locus-mcp</h3>
			<p>Memory tools for assistants and agents, over stdio.</p>
		</article>
		<article class="card">
			<h3>locus-gateway</h3>
			<p>HTTP and gRPC for services that need a host to call.</p>
		</article>
		<article class="card">
			<h3>locus-sdk</h3>
			<p>Rust, when the memory should live inside your process.</p>
		</article>
		<article class="card">
			<h3>locus-cli</h3>
			<p>The same workflows from a terminal, with no service to write.</p>
		</article>
	</section>
